...
APPLICATION='/ticketsampleapplication2140'
...
DESKTOPIMAGENAME='geppettotest/ticketsampleapplication2140-desktop:1.0'
...
helm install --name ticketsampleapplication2140-5322 ./helm
if [ $? -eq 0 ]; then
